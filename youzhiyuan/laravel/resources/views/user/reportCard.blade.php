	...
	<body>
		...
		<ul class="dorm-book mt3">
			...
			<li>
		        ...
		        <span class="info-middle">{{$arr->uname}}</span>  
			</li>
			<li>
				<span class="book-tit">性别</span>
		        <span class="info-middle">{{$arr->ucard}}</span>  
			</li>
			<li>
			...
			<li>
		        ...
		        <span class="info-middle">{{$arr->roomnum}}</span>  
			</li>
			<li>
				<span class="book-tit">铺位</span>
		        <span class="info-middle">{{$arr->bednum}}</span>  
			</li>
		</ul>
		<ul class="dorm-book mt3">
			<li class="basic-tit">
